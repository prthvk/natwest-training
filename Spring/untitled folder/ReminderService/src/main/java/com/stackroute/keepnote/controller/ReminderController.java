...
public class ReminderController {
	...
	public ResponseEntity<?> saveEmployee(@RequestBody Reminder reminder) {
		try {
	...
	public ResponseEntity updateReminder(@RequestBody Reminder reminder, @PathVariable("id") String id) {
		try {
			responseEntity = new ResponseEntity(reminderService.updateReminder(reminder, id), HttpStatus.OK);
		} catch (ReminderNotFoundException e) {
			responseEntity = new ResponseEntity(e.getMessage(), HttpStatus.NOT_FOUND);
		}
		return responseEntity;
	...
	public ResponseEntity getReminder(@PathVariable(value = "id") String id) {
		try {
